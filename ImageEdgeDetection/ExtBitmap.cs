...
namespace ImageEdgeDetection
{
    public static class ExtBitmap
    {
        ...
        public static Bitmap ConvolutionFilterRobert(this Bitmap sourceBitmap,
                                               double[,] xFilterMatrix,
                                               double[,] yFilterMatrix,
                                                     double factor = 1,
                                                          int bias = 0,
        ...
        public static Bitmap CannyEdgeDitection(this Bitmap sourceBitmap,float TH,float TL,int MaskSize, float Sigma){
           ...
           // pg1.Value = 10;
            Canny CannyData = new Canny(sourceBitmap, TH, TL, MaskSize, Sigma);
        ...
        public static Bitmap RobertFilter(this Bitmap sourceBitmap, 
                                              bool grayscale = true)
        {
            Bitmap resultBitmap = ExtBitmap.ConvolutionFilterRobert(sourceBitmap, 
                                                Matrix.RoberHorizontal, 
                                                  Matrix.RobertVerticle, 
                                                        1.0, 0, grayscale);
